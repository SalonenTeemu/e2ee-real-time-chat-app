...
const Home = () => {
	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center bg-blue-50 p-6 text-center">
			...
			{user ? (
				<>
					<p className="mb-6 text-lg text-gray-600">You are logged in. Start chatting now!</p>
				...
				<>
					<p className="mb-6 text-lg text-gray-600">Login or register to start chatting.</p>
